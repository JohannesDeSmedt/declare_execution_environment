...
public class GraphPane extends JPanel implements GraphSelectionListener, KeyListener {
	...
	public GraphPane(GraphListener aGraphListener, JGraph aGraph, String language) {
