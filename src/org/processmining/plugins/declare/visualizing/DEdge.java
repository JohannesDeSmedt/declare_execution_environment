...
public class DEdge extends DefaultEdge implements Cloneable {
	...
	protected void setLineDash(float[] dash) {
		if (dash != null) {
			...
			getAttributes().remove(GraphConstants.DASHPATTERN);
		}
	...
	private void prepare(boolean editable) {
		...
		GraphConstants.setLineWidth(getAttributes(), getLineWidth());
	}
	...
	public Object clone() {
		DEdge myClone = null;
		Object lineClone = lineStyle.clone();
		if (lineClone != null) {
