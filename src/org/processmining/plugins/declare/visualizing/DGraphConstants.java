 ...
 * @version 1.0
 */
public class DGraphConstants extends org.jgraph.graph.GraphConstants {
	...
	public static final float[] DASH_1 = { 5, 5 };
	public static final float[] DASH_2 = { 10, 10 };
	public static final float[] DASH_3 = { 10, 2, 2, 2 };
	...
	/**
	 * Sets the LINEBEGIN attribute in the specified Map<Object,Object> to the
	 * specified value. This attribute indicates what sort of decoration should
	 * be applied to the beginning of edges when they are rendered.
	 * 
	 * @see #ARROW_NONE
	 * @see #ARROW_CLASSIC
	 * @see #ARROW_TECHNICAL
	...
	/**
	 * Sets the beginsize attribute in the specified Map<Object,Object> to the
	 * specified value.
	 */
	...
	public static final Color falseTemporaryColor() {
		Color color = new Color(FALSE_TEMPORARY_RED, FALSE_TEMPORARY_GREEN, FALSE_TEMPORARY_BLUE);
		return color;
	}
	...
	public static final Color falsePermanentColor() {
		Color color = new Color(FALSE_PERMANENET_RED, FALSE_PERMANENET_GREEN, FALSE_PERMANENET_BLUE);
		return color;
	}
	...
	/**
	 * Sets the opaque level attribute in the specified Map<Object,Object> to
	 * the specified value.
	 */
	...
	/**
	 * Sets the middlefill attribute in the specified Map<Object,Object> to the
	 * specified value.
	 */
