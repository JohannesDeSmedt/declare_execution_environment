 ...
 * @version 1.0
 */
public interface AssignmentViewBroker extends AssignmentBroker {
	...
	void readAssignmentGraphicalFromString(AssignmentModel model, AssignmentModelView view, String documentString);
